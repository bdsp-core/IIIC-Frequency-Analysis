function [ theseRect ] = fct_showEEG_avg_wEvents( seg, averageEvents )
%fct_showEEG_avg_wEvents
...
channel_withspace = {'Fp1';'F3';'C3';'P3';'F7';'T3';'T5';'O1';'';'Fz';'Cz';'Pz';'';'Fp2';'F4';'C4';'P4';'F8';'T4';'T6';'O2'};
...
% dispay %
data = [seg(  1: 8,:); gap; seg(  9: 11,:); gap; seg(  12:19,:)];
...
channelLabels_average_withspace_ud = flipud({'Fp1';'F3';'C3';'P3';'F7';'T3';'T5';'O1';'';'Fz';'Cz';'Pz';'';'Fp2';'F4';'C4';'P4';'F8';'T4';'T6';'O2'});
...
channelColors = zeros(21,1);
channelColors(channels_L) = 1;
channelColors(channels_R) = 2;
channelColors(channels_C) = 3;
channelColors_ud = flipud(channelColors);

theseRect = cell(size(averageEvents,1),1);
for j=1:size(averageEvents,1)
    thisEvent = averageEvents(j,:);
    thisChanName = thisEvent.channel;
    chan= thisEvent.channelNum;
    thisBB = thisEvent.BoundingBox;
    indx_chan = find(ismember(channelLabels_average_withspace_ud,thisChanName));
