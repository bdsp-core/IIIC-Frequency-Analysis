function [ LOC, theseEvents, eeg_bp_smooth ] = fct_findEvents_hilo_dynamic_auto4_nleo( seg, Fs,...
    thresh_hi, thresh_lo, smoothWin, freq_lo, freq_hi, boostWin, meanWin, channelLabels)
%fct_findEvents_hilo_dynamic_auto4_nleo.  Use a high-low threshold approach to find events. Naive to specific BP or montage.
