  function f= fct_showEEG_avg(seg_avg) 

        f = gcf;
%         Ax_EEG = subplot('position',[.05 .05 .93 .9]);
        Ax_EEG = gca;
        
        gap = nan(1,size(seg_avg,2));
...
%     channel_withspace = {'Fp1-F7';'F7-T3';'T3-T5';'T5-O1'; '';'Fp2-F8';'F8-T4';'T4-T6';'T6-O2'; '';'Fp1-F3';'F3-C3';'C3-P3';'P3-O1'; '';'Fp2-F4';'F4-C4';'C4-P4';'P4-O2'; '';'Fz-Cz';'Cz-Pz'};
    ii = 1;
            ...
            % dispay %
            data = [seg_avg(  1: 8,:); gap; seg_avg(  9: 11,:); gap; seg_avg(  12:19,:)];

            nCh = size(data, 1);
            DCoff = repmat(flipud((1:nCh)'), 1, size(seg_avg , 2));
