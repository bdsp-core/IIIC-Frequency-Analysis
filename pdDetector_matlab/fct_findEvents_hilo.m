function [ LOC, theseEvents, eeg_bp_smooth ] = fct_findEvents_hilo( seg, Fs, thresh_hi, thresh_lo, smoothWin, freq_lo, freq_hi,channelLabels)
%fct_findEvents_hilo.  Use a high-low threshold approach to find events. Naive to specific BP or montage.
% ***
