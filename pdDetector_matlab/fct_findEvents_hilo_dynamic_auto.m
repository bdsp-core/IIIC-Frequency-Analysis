function [ LOC, theseEvents, eeg_bp_smooth ] = fct_findEvents_hilo_dynamic_auto( seg, Fs,...
...
%         theseEvents = cell(size(eeg_bp,1),1);
        ...
        eeg_rms = simplema(iqr(eeg_bp_smooth,1),meanWin,2);
        ...
        for j=1:size(eeg_bp_smooth_transf,1)
           ...
           % high-low threshold
           bw_hi = thisEEG_bp_smooth>thresh_hi*eeg_rms;
           bw_lo = thisEEG_bp_smooth>thresh_lo*eeg_rms;
