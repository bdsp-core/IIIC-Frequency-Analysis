...
def pd_detect(
    ...
    seg_bi = iiic_detector.utils.l_bipolar(seg)
    ...
    c_bi = iiic_detector.utils.get_channel_labels_bipolar()
    ...
    loc, bipolar_events, eeg_bp_smooth = iiic_detector.hilo_dynamic_auto6(
        seg_bi,
        Fs,
        thresh_hi,
        thresh_lo,
    ...
    pd_events_bi = iiic_detector.utils.select_events(bipolar_events, criteria)

    if DEBUG_FLAG:
        # TODO: Implement fct_vizEEG_bipolar(eeg_bp_smooth)
        pass

    group_events_bi = iiic_detector.group_events_bi(
        pd_events_bi,
        seg_bi,
        eeg_bp_smooth,
        c_bi,
    ...
    # TODO: Implement
    spatial_extent = iiic_detector.calc_spatial_extent(group_events_bi_gt0, c_bi)

    data_obj = {
        "seg_bi": seg_bi,
        "this_loc": this_loc,
        "pd_events_bi": pd_events_bi,
        "pd_events_bi_select": iiic_detector.utils.cull_events_by_channel(
