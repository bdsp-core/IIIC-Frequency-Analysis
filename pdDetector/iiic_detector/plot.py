...
def show_eeg_events_and_stats(data_obj):
    ...
    locs, peaks = scipy.signal.find_peaks(
        iiic_detector.utils.smooth(this_loc, 10),
        distance=20,
        height=(None, None),
        width=(None, None),
        prominence=2,
    ...
    axs_events[0].plot(iiic_detector.utils.smooth(this_loc, 10))
    ...
    seg_bi = iiic_detector.eegfilt(seg_bi, 200, 1, 40, 0, 0, 0, "fir1", 0)
